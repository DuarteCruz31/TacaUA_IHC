...
class AndebolPage extends StatefulWidget {
  const AndebolPage({Key? key}) : super(key: key);
  @override
  State<AndebolPage> createState() => _AndebolPageState();
}

// Lista de emojis para a scrollbar horizontal
class _AndebolPageState extends State<AndebolPage> {
  @override
